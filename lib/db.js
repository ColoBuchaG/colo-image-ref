...
export function openDb(dataDir) {
  ...
  if (!imageCols.includes('manual_order')) {
    db.exec('ALTER TABLE images ADD COLUMN manual_order INTEGER NOT NULL DEFAULT 0');
  }
  db.exec('UPDATE images SET manual_order = id WHERE manual_order = 0');
  ...
  db.exec(`
    ...
    CREATE INDEX IF NOT EXISTS idx_images_manual_order ON images(manual_order);
